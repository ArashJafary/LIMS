...
public class OperationResult<TResult>
{
    ...
    public static OperationResult<TResult> OnSuccess(TResult result) => new OperationResult<TResult>(result);
    public static OperationResult<TResult> OnFailed(string message) => new OperationResult<TResult>(message);
    public static OperationResult<TResult> OnException(Exception exception) => new OperationResult<TResult>(exception);
}